...
free-verse stanzas, the only vowel letter allowed anywhere is E. A, I, O,
U are forbidden in any position (a letter-level constraint, not a
phonetic one, following the precedent set by 0038, 0039, and 0040's own
...
are commentary, not the poem. Free verse, no stanza-number headers to
exclude: nothing but blank lines separates one stanza from the next.

Also reports word-count statistics: total words, distinct words, and the
distinct-word ratio at word 49 and word 98 (to compare directly against
0038's 49/98 result and 0040's 50/98 result) and at the poem's full
length.
...
if __name__ == "__main__":
    ...
    print("Clean. Every letter in every word is E, or a consonant, or Y. "
          "No A, I, O, U anywhere.")
    ...
    print("Contains literal pronoun 'I'?", "i" in words)
    sys.exit(0)
